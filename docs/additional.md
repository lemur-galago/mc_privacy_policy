...
> [!WARNING]
> До версии 2.0.0015 серверу приложений отправляется запрос `POST /exec/mobileApiResult?p=<tag>`
> 
...
или эндпоинт сервера lsFusion и передать json-массив прочитанных штрихкодов.
